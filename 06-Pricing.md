...
Let's cluster like games together based on their event scores. We'll use the _kmeans_ function to group our games together. You'll see kmeans getting used quite a bit. It is relatively simple to understand and does a good job of discriminating numerical data sets. 
...
The Ecdf function from the Hmisc package will give you coordinates for the cumulative distribution. We'll use the _reshape2_ [@R-reshape2] package to _melt_ the data frame. This package helps pivot data and the results will be identical to using tools in the tidyr package that we have already seen.
...
We can also use the _pricesensitivitymeter_ package to produce our analysis a little more quickly. 
